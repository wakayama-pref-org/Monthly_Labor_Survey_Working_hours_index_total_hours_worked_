# Monthly_Labor_Survey_Working_hours_index_total_hours_worked_
【毎月勤労統計調査(和歌山県)_産業別時系列表（労働時間指数（総労働時間）及び対前年比)です。】
◆毎月勤労統計調査とは
〇調査の目的
...
http://www.pref.wakayama.lg.jp/prefg/020300/jikeiretu/kinro/koumokubetu/sou jikan.xls
